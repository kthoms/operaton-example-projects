# 05 Building Block View — loan-platform-sso
...
```
┌──────────────────────────────────────────────────────────────────────────────┐
│  loan-platform-sso (Docker Compose stack)                                    │
│                                                                              │
│  ┌──────────────┐   ┌───────────────┐   ┌──────────────────────────────┐   │
...
- **Image:** `loan-platform-sso-engine:local` (built from `engine/Dockerfile`)
...
- **Image:** `loan-platform-sso-worker:local` (built from `worker/Dockerfile`)
